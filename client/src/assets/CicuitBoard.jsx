...
const groupAnimation = {
  ...
  visible: {
    strokeDashoffset: 0,
    stroke: "#b35dc8", // Changes stroke color after drawing
    transition: {
      duration: 15,
      ease: "easeInOut",
      staggerChildren: 0.3, // Adds a delay between paths drawing
    },
  },
};
const rectAnimation = {
  initial: { scale: 0.5, fill: "#5e0a7a" }, // Start small with first color
  animate: {
    scale: [0.9, 1, 0.9], // Popping effect
    stroke: [
      "#5e0a7a",
      "#ff5733",
      "#33ff57",
    ...
    transition: {
      duration: 3, // Full animation cycle
      ease: "easeInOut",
    ...
    >
      ...
      <g id="CircuitBoard">
        ...
        <motion.path
          ...
          stroke="#b35dc8"
          strokeWidth="2"
          strokeDasharray="6482.33984375"
          strokeDashoffset="6482.33984375"
          initial={{
            strokeDashoffset: 6482.33984375,
            stroke: "#2a0034",
          }}
        ...
        <motion.path
          ...
          stroke="#b35dc8"
          strokeWidth="2"
          strokeDasharray="9899.86328125"
          strokeDashoffset="9899.86328125"
          initial={{
            strokeDashoffset: 9899.86328125,
            stroke: "#2a0034",
          }}
        ...
        <motion.g
          ...
          initial="hidden"
          animate="visible" /* Controls speed */
        >
          <path
            id="Vector 11"
        ...
        <motion.path
          ...
          stroke="black"
          strokeWidth="2"
          strokeDasharray="7205.7060546875"
          strokeDashoffset="7205.7060546875"
          initial={{
            strokeDashoffset: 7205.7060546875,
            stroke: "#2a0034",
          }}
        ...
        <motion.path
          ...
          stroke="black"
          strokeWidth="2"
          strokeDasharray="1703.882568359375"
          strokeDashoffset="1703.882568359375"
          initial={{
            strokeDashoffset: 1703.882568359375,
            stroke: "#2a0034",
          }}
        ...
        <motion.path
          ...
          stroke="black"
          strokeWidth="2"
          strokeDasharray="12416.892578125"
          strokeDashoffset="12416.892578125"
          initial={{
            strokeDashoffset: 12416.892578125,
            stroke: "#2a0034",
          }}
        ...
        <motion.path
          ...
          stroke="black"
          strokeWidth="2"
          strokeDasharray="10503.2333984375"
          strokeDashoffset="10503.2333984375"
          initial={{
            strokeDashoffset: 10503.2333984375,
            stroke: "#94b959",
          }}
